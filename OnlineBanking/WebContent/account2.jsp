			...
			<ul class="menu ml-auto mt-1">
				...
				<li class="nav-item dropdown">
				    ...
				    <div class="dropdown-menu">
				      <% for(Account listaccount:customer.getAccounts()){
				    	  out.print("<a class=\"dropdown-item\" href=\"account.jsp?accountnumber="+listaccount.getAccountNumber()+"\">"+listaccount.getAccountType()+" | Acct#: "+listaccount.getAccountNumber()+" | Balance $"+listaccount.getAccountBalance());out.print("</a>");
				      }
				      %>
				    </div>
				 </li>
...
<section class="contact py-5">
	<div class="container py-lg-5">
		<h2 class="heading mb-sm-5 mb-4">Account Details</h2>
