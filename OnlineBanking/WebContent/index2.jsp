...
<body data-spy="scroll" data-target="#navbar-example">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
            ...
            <nav class="navbar navbar-default">
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1 sticky-top" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li>
                    <a class="page-scroll" href="#newaccount"><strong>Open an Account Today!</strong></a>
                  </li>
                  <li>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="layer-1-1 hidden-xs wow slideInDown" data-wow-duration="2s" data-wow-delay=".2s">
                  <h2 class="title1">The Best Bank </h2>
                </div>
                <!-- layer 2 -->
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">We're In The Business Of Helping You Manage Your Money</h1>
                </div>
                <!-- layer 3 -->
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content text-center">
                ...
                <!-- layer 2 -->
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">Providing Quality Personal and Business Banking Solutions</h1>
                </div>
                <!-- layer 3 -->
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="#services">See Services</a>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <!-- layer 2 -->
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">Helping Secure Your Financial Future</h1>
                </div>
                <!-- layer 3 -->
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="#services">See Services</a>
  ...
  <!-- End Contact Area -->
   ...
   <!-- Start New Account Area -->
  <div id="newaccount" class="contact-area">
    <div class="contact-inner area-padding">
      <div class="contact-overly"></div>
      <div class="container ">
        <div class="row">
              ...
              <form action="/NewAccountServlet" method="post">
               ...
               <div class="form-group">
                ...
                <label for="initialdeposit">Initial Deposit</label>
                  <input type="text" class="form-control" name="initialdeposit" id="initialdeposit" placeholder="Your Inital Deposit" data-rule="minlen:1" data-msg="Please enter at least 1 chars" />
                  <div class="validation"></div>
                </div>
<!-- 				<div class="form-group form-inline input-group mb-3">
 ...
 -->
  ...
  <script src="lib/bootstrap-formhelpers/bootstrap-formhelpers-phone.js"></script>
  	<script
